...
# export CUDA_VISIBLE_DEVICES=0 && python pruning.py --model "/data2/jwllm/models_origin/qwen3_0.6b_base" --pruning_ratio 0.2 --max_seq_len 4096 --save_model "/data2/jwllm/model_process/qwen3_0.6B_base_pruning_test"
...
# Load and process by terminal dataset
def get_wikitext2(nsamples, seed, seqlen, tokenizer):
    ...
    traindata = load_dataset(
        'parquet',
        data_files='/data2/jwllm/datasets/prune_parquet/prune_train.parquet',
        split='train')
    testdata = load_dataset(
        'parquet',
        data_files='/data2/jwllm/datasets/prune_parquet/prune_test.parquet',
        split='train')  # 数据集中测试集部分也是train的title
